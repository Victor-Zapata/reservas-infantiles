...
export default function ConsentimientoPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!consentimiento || usoImagen === '' || !terminos) {
      setError('Por favor completá todos los campos obligatorios para continuar.');
      return;
    }
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4 border rounded p-4">
          ...
          <p className="small text-muted">
            Aquí irá el texto legal que describe el consentimiento informado, la asunción de riesgo
            y el deslinde de responsabilidad. El cliente debe aceptar este consentimiento para
            continuar.
          </p>
        ...
        <div className="mb-4 border rounded p-4">
          ...
          <p className="small text-muted">
            ¿Autorizás a que tomemos fotos o videos del niño/a con fines promocionales internos?
          </p>
        ...
        <div className="mb-4 border rounded p-4">
          ...
          <p className="small text-muted">
            Aquí irá el texto sobre términos y condiciones de uso del servicio, normas de
            convivencia, política de cancelación, etc.
          </p>
